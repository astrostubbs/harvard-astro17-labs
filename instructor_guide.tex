...
This guide accompanies the Python Jupyter notebooks for Astro 17, Harvard's introductory course in extragalactic astronomy and cosmology. The notebooks provide hands-on computational exercises covering topics from stellar populations to cosmological distance measurements.

All notebooks are designed to run on Google Colab, a cloud-based Jupyter notebook environment that requires no local software installation.
